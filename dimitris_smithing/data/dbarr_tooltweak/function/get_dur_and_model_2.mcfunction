...
$execute if data storage dbarr:tmp ext_equip_feet run item modify entity @s armor.feet {function:"minecraft:filtered", item_filter:{items:"$(item_id)", predicates:{"minecraft:damage":{durability:{max:$(delta)}}}}, modifier: {function:"minecraft:sequence", functions:[{function:"minecraft:set_custom_data",tag:{dbarr_equip_in:{slot:"feet"}}},  {function:"minecraft:set_components", components: {"minecraft:equippable":{slot:"feet", damage_on_hurt:0}}}] }}

$execute if data storage dbarr:tmp ext_equip_legs run item modify entity @s armor.legs {function:"minecraft:filtered", item_filter:{items:"$(item_id)", predicates:{"minecraft:damage":{durability:{max:$(delta)}}}}, modifier: {function:"minecraft:sequence", functions:[{function:"minecraft:set_custom_data",tag:{dbarr_equip_in:{slot:"legs"}}},  {function:"minecraft:set_components", components: {"minecraft:equippable":{slot:"legs", damage_on_hurt:0}}}] }}

$execute if data storage dbarr:tmp ext_equip_chest run item modify entity @s armor.chest {function:"minecraft:filtered", item_filter:{items:"$(item_id)", predicates:{"minecraft:damage":{durability:{max:$(delta)}}}}, modifier: {function:"minecraft:sequence", functions:[{function:"minecraft:set_custom_data",tag:{dbarr_equip_in:{slot:"chest"}}},  {function:"minecraft:set_components", components: {"minecraft:equippable":{slot:"chest", damage_on_hurt:0}}}] }}

$execute if data storage dbarr:tmp ext_equip_head run item modify entity @s armor.head {function:"minecraft:filtered", item_filter:{items:"$(item_id)", predicates:{"minecraft:damage":{durability:{max:$(delta)}}}}, modifier: {function:"minecraft:sequence", functions:[{function:"minecraft:set_custom_data",tag:{dbarr_equip_in:{slot:"head"}}},  {function:"minecraft:set_components", components: {"minecraft:equippable":{slot:"head", damage_on_hurt:0, asset_id:"minecraft:armadillo_scute"}}}] }}

$item modify entity @s $(broken_item_slot) {function:"minecraft:filtered", item_filter:{items:"$(item_id)", predicates:{"minecraft:damage":{durability:{max:$(delta)}}}}, modifier: {function:"minecraft:sequence", functions: [{function:"minecraft:set_item", item:"minecraft:structure_block"}, {function:"set_enchantments",enchantments:{"dbarr_tooltweak:broken":1}}, {function:"minecraft:set_components", components: {"minecraft:max_damage":$(item_durability), "minecraft:max_stack_size":1, "minecraft:item_model":"$(item_id)", "minecraft:enchantment_glint_override":0b, "minecraft:rarity":"common"}}, {function:"minecraft:set_damage",damage:0}, {function:"minecraft:set_custom_data",tag:{dbarr_broken_tool:{"id": "$(item_id)"}, "dbarr_tooltweak_repairable":0}} ]}}
